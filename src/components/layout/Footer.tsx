      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 px-4">
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-400 text-sm">
            এখানে বিভিন্ন ধরনের লোরেম ইপসাম উপলব্ধ আছে, তবে বেশিরভাগই ভুক্তভোগী।
          </p>
        ...
        <div className="space-y-2">
          ...
          <ul className="space-y-2 text-gray-400">
            <li>
              <Link href="/about">
                <span className="hover:text-green-400">আমাদের সম্পর্কে</span>
              </Link>
            </li>
            <li>
              <Link href="/services">
                <span className="hover:text-green-400">সেবাসমূহ</span>
              </Link>
            </li>
            <li>
              <Link href="/projects">
                <span className="hover:text-green-400">আমাদের প্রকল্প</span>
              </Link>
            </li>
            <li>
              <Link href="/farmers">
                <span className="hover:text-green-400">কৃষকরা</span>
              </Link>
            </li>
            <li>
              <Link href="/news">
                <span className="hover:text-green-400">সাম্প্রতিক খবর</span>
              </Link>
            </li>
            <li>
              <Link href="/contact">
                <span className="hover:text-green-400">যোগাযোগ</span>
              </Link>
            </li>
          </ul>
        </div>
        ...
        <div className="space-y-2">
          ...
          <ul className="space-y-2 text-gray-400">
            <li>
              ...
              <span className="text-sm text-gray-500">জুলাই ৫, ২০২২</span>
            </li>
            <li>
              <Link href="/news/2">
                <span className="hover:text-green-400">
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-400">
            <i className="fas fa-map-marker-alt"></i> ৮০ ব্রুকলিন গোল্ডেন
